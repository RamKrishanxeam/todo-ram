...
import { signInWithGooglePopup } from "../firebas/firebase";
        ...
        <div className="max-w-screen-xl bg-white shadow sm:rounded-lg flex justify-center flex-1">
          <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
            ...
            <div className="flex flex-col items-center">
              <button className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline">
                ...
                <span className="ml-4" onClick={logGoogleUser}>
                  Sign Up with Google
                </span>
              </button>
            </div>
          ...
          <div className="flex-1 bg-indigo-100 text-center hidden lg:flex">
            <div
              ...
              style={{
                backgroundImage:
                  "url(https://storage.googleapis.com/devitary-image-host.appspot.com/15846435184459982716-LogoMakr_7POjrN.png)",
              }}
            ></div>
          </div>
        </div>
